      ...
      if (stryMutAct_9fa48('71')) {
        ...
        if (
          ...
          if (stryMutAct_9fa48('74')) {
            ...
            stryCov_9fa48('74');
            let fileName = stryMutAct_9fa48('75')
              ? Date.now().toString() - req.files.image.name
              : (stryCov_9fa48('75'), Date.now().toString() + req.files.image.name);
            const __dirname = dirname(fileURLToPath(import.meta.url));
            req.files.image.mv(
              path.join(
                __dirname,
                stryMutAct_9fa48('76') ? '' : (stryCov_9fa48('76'), '..'),
                stryMutAct_9fa48('77') ? '' : (stryCov_9fa48('77'), 'uploads'),
                fileName
              )
            );
  ...
  if (stryMutAct_9fa48('88')) {
    ...
    try {
      if (stryMutAct_9fa48('89')) {
        ...
        stryCov_9fa48('89');
        const posts = await (stryMutAct_9fa48('90')
          ? Post.find()
          : (stryCov_9fa48('90'),
            Post.find().sort(stryMutAct_9fa48('91') ? '' : (stryCov_9fa48('91'), '-createdAt'))));
        const popularPosts = await (stryMutAct_9fa48('92')
          ? Post.find().limit(5)
          : (stryCov_9fa48('92'),
            Post.find()
              .limit(5)
              .sort(stryMutAct_9fa48('93') ? '' : (stryCov_9fa48('93'), '-views'))));
        if (
          stryMutAct_9fa48('96')
            ? false
            : stryMutAct_9fa48('95')
      ...
      if (stryMutAct_9fa48('101')) {
        ...
        res.json(
          stryMutAct_9fa48('102')
            ...
            : (stryCov_9fa48('102'),
              {
                message: stryMutAct_9fa48('103')
                  ? ''
                  : (stryCov_9fa48('103'), 'Щось пішло не так.'),
              })
        );
      }
    }
      ...
      if (stryMutAct_9fa48('110')) {
        ...
        res.json(
          stryMutAct_9fa48('111')
            ...
            : (stryCov_9fa48('111'),
              {
                message: stryMutAct_9fa48('112')
                  ? ''
                  : (stryCov_9fa48('112'), 'Щось пішло не так.'),
              })
        );
      }
    }
      ...
      if (stryMutAct_9fa48('116')) {
        ...
        res.json(
          stryMutAct_9fa48('117')
            ...
            : (stryCov_9fa48('117'),
              {
                message: stryMutAct_9fa48('118')
                  ? ''
                  : (stryCov_9fa48('118'), 'Щось пішло не так.'),
              })
        );
      }
    }
          ...
          stryMutAct_9fa48('123')
            ...
            : stryMutAct_9fa48('122')
              ...
              : stryMutAct_9fa48('121')
                ? post
                : (stryCov_9fa48('121', '122', '123'), !post)
        )
          return res.json(
            stryMutAct_9fa48('124')
              ...
              : (stryCov_9fa48('124'),
                {
                  message: stryMutAct_9fa48('125')
                    ? ''
                    : (stryCov_9fa48('125'), 'Такого поста не існує.'),
                })
          );
        await User.findByIdAndUpdate(
          req.userId,
      ...
      if (stryMutAct_9fa48('130')) {
        ...
        res.json(
          stryMutAct_9fa48('131')
            ...
            : (stryCov_9fa48('131'),
              {
                message: stryMutAct_9fa48('132')
                  ? ''
                  : (stryCov_9fa48('132'), 'Щось пішло не так.'),
              })
        );
      }
    }
        ...
        if (
          stryMutAct_9fa48('136')
            ...
            : stryMutAct_9fa48('135')
              ? true
              : (stryCov_9fa48('135', '136'), req.files)
        ) {
          if (stryMutAct_9fa48('137')) {
            ...
            stryCov_9fa48('137');
            let fileName = stryMutAct_9fa48('138')
              ? Date.now().toString() - req.files.image.name
              : (stryCov_9fa48('138'), Date.now().toString() + req.files.image.name);
            const __dirname = dirname(fileURLToPath(import.meta.url));
            req.files.image.mv(
              path.join(
                __dirname,
                stryMutAct_9fa48('139') ? '' : (stryCov_9fa48('139'), '..'),
                stryMutAct_9fa48('140') ? '' : (stryCov_9fa48('140'), 'uploads'),
                fileName
              )
            );
            post.imgUrl = stryMutAct_9fa48('143')
              ? fileName && ' '
              : stryMutAct_9fa48('142')
                ...
                : stryMutAct_9fa48('141')
                  ...
                  : (stryCov_9fa48('141', '142', '143'),
                    fileName || (stryMutAct_9fa48('144') ? '' : (stryCov_9fa48('144'), ' ')));
          }
        }
        post.title = title;
        post.text = text;
      ...
      if (stryMutAct_9fa48('145')) {
        ...
        res.json(
          stryMutAct_9fa48('146')
            ...
            : (stryCov_9fa48('146'),
              {
                message: stryMutAct_9fa48('147')
                  ? ''
                  : (stryCov_9fa48('147'), 'Щось пішло не так.'),
              })
        );
      }
    }
          ...
          stryMutAct_9fa48('152')
            ...
            : stryMutAct_9fa48('151')
              ...
              : stryMutAct_9fa48('150')
                ? post
                : (stryCov_9fa48('150', '151', '152'), !post)
        ) {
          if (stryMutAct_9fa48('153')) {
            ...
            return res.status(404).json(
              stryMutAct_9fa48('154')
                ...
                : (stryCov_9fa48('154'),
                  {
                    message: stryMutAct_9fa48('155')
                      ? ''
                      : (stryCov_9fa48('155'), 'Пост не знайдено'),
                  })
            );
          }
        }
      ...
      if (stryMutAct_9fa48('157')) {
        ...
        res.json(
          stryMutAct_9fa48('158')
            ...
            : (stryCov_9fa48('158'),
              {
                message: stryMutAct_9fa48('159')
                  ? ''
                  : (stryCov_9fa48('159'), 'Щось пішло не так.'),
              })
        );
      }
    }
